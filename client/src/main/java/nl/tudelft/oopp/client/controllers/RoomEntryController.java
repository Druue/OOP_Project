...
public class RoomEntryController {
    ...
    public void generateTimeline(TestOpeningTimes openingTimes, List<TestTimeSlot> timeSlots) {
        ...
        if(openingTimes.getOpeningHour().getMinutes() > 30 || openingTimes.getOpeningHour().getMinutes() == 0) {
            startsWithRoundHour = true;
        } else {startsWithRoundHour = false;}
...
//        StackPane area = new StackPane();
        ...
        for(int i = 0; i != numTimeSlots; i++) {
            ...
            if((startsWithRoundHour && i%2 == 0) || (!startsWithRoundHour && i%2 != 0)) {
                ...
                fullHourMark.translateXProperty().bind(timeSlot.widthProperty().multiply(i).subtract(timeline.getPrefWidth()/numTimeSlots/2));
                ...
                hour.translateXProperty().bind(timeSlot.widthProperty().multiply(i).subtract(timeline.getPrefWidth() / numTimeSlots / 2 + hourTranslateX));
                ...
                halfHourMark.translateXProperty().bind(timeSlot.widthProperty().multiply(i).subtract(timeline.getPrefWidth()/numTimeSlots/2));
                halfHourMark.setFill(Color.valueOf("000000"));

                hour.translateXProperty().bind(timeSlot.widthProperty().multiply(i).subtract(timeline.getPrefWidth()/numTimeSlots/2));
